        ...
        <div class="col-md-4 col-md-offset-4">
          <form action="<?=site_url('stock/process')?>" method="post">
            <div class="form-group">
              <label>Date *</label>
              <input type="date" name="date" value="<?=date('Y-m-d')?>" autocomplete="off" class="form-control" required>
            </div>
            <div>
            ...
            <div class="form-group">
              ...
              <input type="text" name="item_name" id="item_name"  autocomplete="off" class="form-control" readonly>
            </div>
            <div class="form-group">
            	<div class="row">
            		<div class="col-md-8">
            ...
            <div class="form-group">
              ...
              <input type="text" name="detail" class="form-control" required placeholder="kulakan / tambahan / etc">
            </div>
            <div class="form-group">
